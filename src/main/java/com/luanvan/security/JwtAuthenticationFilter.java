...
public class JwtAuthenticationFilter extends OncePerRequestFilter{
	...
	private final JwtDecoder jwtDecoder; //convert JWT to DecodedJWT
	
	private final JwtToPrincipalConverter jwtToPrincipalConverter; //covert DecodedJWT to UserPrincipal
